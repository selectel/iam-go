...
const (
	federationGroupMappingsURL        = "v1/federations/oidc/123/group-mappings"
	federationExternalGroupMappingURL = "v1/federations/oidc/123/group-mappings/456/external-groups/external-group"
)
